  ...
  var d2 = function() {
    ...
    return e3.prototype.acquireLock = function(t2, n3) {
      return void 0 === n3 && (n3 = 5e3), o2(this, void 0, void 0, function() {
        var o3, i2, s3, d3, l2, p2, m2;
        return r2(this, function(r3) {
          switch (r3.label) {
            case 0:
              o3 = Date.now() + h2(4), i2 = Date.now() + n3, s3 = a2 + "-" + t2, d3 = void 0 === this.storageHandler ? c2 : this.storageHandler, r3.label = 1;
            case 1:
              return Date.now() < i2 ? [4, u2(30)] : [3, 8];
            case 2:
              return r3.sent(), null !== d3.getItemSync(s3) ? [3, 5] : (l2 = this.id + "-" + t2 + "-" + o3, [4, u2(Math.floor(25 * Math.random()))]);
            case 3:
              return r3.sent(), d3.setItemSync(s3, JSON.stringify({ id: this.id, iat: o3, timeoutKey: l2, timeAcquired: Date.now(), timeRefreshed: Date.now() })), [4, u2(30)];
            case 4:
              return r3.sent(), null !== (p2 = d3.getItemSync(s3)) && (m2 = JSON.parse(p2)).id === this.id && m2.iat === o3 ? (this.acquiredIatSet.add(o3), this.refreshLockWhileAcquired(s3, o3), [2, true]) : [3, 7];
            case 5:
              return e3.lockCorrector(void 0 === this.storageHandler ? c2 : this.storageHandler), [4, this.waitForSomethingToChange(i2)];
            case 6:
              r3.sent(), r3.label = 7;
            case 7:
              return o3 = Date.now() + h2(4), [3, 1];
            case 8:
              return [2, false];
          }
        });
      ...
      for (var c3 = false, u3 = 0; u3 < i2.length; u3++) {
        var h3 = i2[u3];
        if (h3.includes(a2)) {
          var d3 = o3.getItemSync(h3);
          if (null !== d3) {
            var l2 = JSON.parse(d3);
            (void 0 === l2.timeRefreshed && l2.timeAcquired < n3 || void 0 !== l2.timeRefreshed && l2.timeRefreshed < n3) && (o3.removeItemSync(h3), c3 = true);
          }
        }
      }
      c3 && e3.notifyWaiters();
...
var a = { name: "auth0-spa-js", version: "2.4.1" };
var c = () => Date.now();
...
var h = class _h extends u {
  constructor(e2, t2, n2, o2 = null) {
    super(e2, t2), this.state = n2, this.appState = o2, Object.setPrototypeOf(this, _h.prototype);
  }
};
var d = class _d extends u {
  constructor() {
    super("timeout", "Timeout"), Object.setPrototypeOf(this, _d.prototype);
  }
};
var l = class _l extends d {
  constructor(e2) {
    super(), this.popup = e2, Object.setPrototypeOf(this, _l.prototype);
  }
};
...
var m = class _m extends u {
  constructor(e2, t2, n2) {
    super(e2, t2), this.mfa_token = n2, Object.setPrototypeOf(this, _m.prototype);
  }
};
var f = class _f extends u {
  constructor(e2, t2) {
    super("missing_refresh_token", `Missing Refresh Token (audience: '${w(e2, ["default"])}', scope: '${w(t2)}')`), this.audience = e2, this.scope = t2, Object.setPrototypeOf(this, _f.prototype);
  }
};
var g = class _g extends u {
  constructor(e2) {
    super("use_dpop_nonce", "Server rejected DPoP proof: wrong nonce"), this.newDpopNonce = e2, Object.setPrototypeOf(this, _g.prototype);
  }
};
function w(e2, t2 = []) {
...
var _ = (e2) => ((e3) => decodeURIComponent(atob(e3).split("").map((e4) => "%" + ("00" + e4.charCodeAt(0).toString(16)).slice(-2)).join("")))(e2.replace(/_/g, "/").replace(/-/g, "+"));
...
async function P(e2, t2, n2) {
  ...
  const o2 = `${j(T(JSON.stringify(e2)))}.${j(T(JSON.stringify(t2)))}`;
  return `${o2}.${j(await crypto.subtle.sign(function(e3) {
...
async function N(e2, t2, n2, o2, i2, r2) {
  ...
  return P({ alg: E(s2), typ: "dpop+jwt", jwk: await U(a2) }, Object.assign(Object.assign({}, r2), { iat: Math.floor(Date.now() / 1e3), jti: crypto.randomUUID(), htm: n2, nonce: o2, htu: t2, ath: i2 ? j(await crypto.subtle.digest("SHA-256", T(i2))) : void 0 }), s2);
}
async function U(e2) {
  const { kty: t2, e: n2, n: o2, x: i2, y: r2, crv: s2 } = await crypto.subtle.exportKey("jwk", e2);
  return { kty: t2, crv: s2, e: n2, n: o2, x: i2, y: r2 };
}
var Z = ["authorization_code", "refresh_token", "urn:ietf:params:oauth:grant-type:token-exchange"];
function R() {
...
function A({ keyPair: e2, url: t2, method: n2, nonce: o2, accessToken: i2 }) {
  const r2 = function(e3) {
    const t3 = new URL(e3);
    return t3.search = "", t3.hash = "", t3.href;
  }(t2);
  return N(e2, r2, n2, o2, i2);
}
var W = async (e2, t2) => {
...
var L = async (e2, t2, n2) => {
  const o2 = new AbortController();
  let i2;
  return t2.signal = o2.signal, Promise.race([W(e2, t2), new Promise((e3, t3) => {
    i2 = setTimeout(() => {
...
var V = async (e2, t2, n2, o2, i2, r2, s2) => {
  return a2 = { auth: { audience: t2, scope: n2 }, timeout: i2, fetchUrl: e2, fetchOptions: o2, useFormData: s2 }, c2 = r2, new Promise(function(e3, t3) {
...
var X = async (e2, t2, n2, o2, i2, r2, s2 = 1e4) => i2 ? V(e2, t2, n2, o2, s2, i2, r2) : L(e2, o2, s2);
async function F(t2, n2, o2, i2, r2, s2, a2, c2, h2) {
  if (c2) {
  ...
  for (let e2 = 0; e2 < 3; e2++) try {
    d2 = await X(t2, o2, i2, r2, s2, a2, n2), l2 = null;
    break;
  } catch (e3) {
    l2 = e3;
  }
  ...
  if (c2 && (_2 = k2["dpop-nonce"], _2 && await c2.setNonce(_2)), !v2) {
    ...
    if ("missing_refresh_token" === w2) throw new f(o2, i2);
    if ("use_dpop_nonce" === w2) {
      if (!c2 || !_2 || h2) throw new g(_2);
      return F(t2, n2, o2, i2, r2, s2, a2, c2, true);
    }
...
async function J(t2, n2) {
  var { baseUrl: o2, timeout: i2, audience: r2, scope: s2, auth0Client: c2, useFormData: u2, dpop: h2 } = t2, d2 = e(t2, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData", "dpop"]);
  ...
  var g2;
  return await F(`${o2}/oauth/token`, i2, r2 || "default", s2, { method: "POST", body: m2, headers: { "Content-Type": u2 ? "application/x-www-form-urlencoded" : "application/json", "Auth0-Client": btoa(JSON.stringify(c2 || a)) } }, n2, u2, f2 ? h2 : void 0);
}
var G = (...e2) => {
...
var M = class _M {
  ...
  static fromKey(e2) {
    ...
    return new _M({ clientId: n2, scope: i2, audience: o2 }, t2);
  }
  static fromCacheEntry(e2) {
    const { scope: t2, audience: n2, client_id: o2 } = e2;
    return new _M({ scope: t2, audience: n2, clientId: o2 });
  }
};
var Y = class {
  set(e2, t2) {
...
var B = class {
  ...
  async get(e2, t2 = 0) {
    ...
    if (!o2) {
      ...
      n3 && (o2 = await this.cache.get(n3));
    }
    if (!o2) return;
    const i2 = await this.nowProvider(), r2 = Math.floor(i2 / 1e3);
    return o2.expiresAt - t2 < r2 ? o2.body.refresh_token ? (o2.body = { refresh_token: o2.body.refresh_token }, await this.cache.set(e2.toKey(), o2), o2.body) : (await this.cache.remove(e2.toKey()), void await (null === (n2 = this.keyManifest) || void 0 === n2 ? void 0 : n2.remove(e2.toKey()))) : o2.body;
  }
  async set(e2) {
    var t2;
    const n2 = new M({ clientId: e2.client_id, scope: e2.scope, audience: e2.audience }), o2 = await this.wrapCacheEntry(e2);
  ...
  matchExistingCacheKey(e2, t2) {
    return t2.filter((t3) => {
      var n2;
      const o2 = M.fromKey(t3), i2 = new Set(o2.scope && o2.scope.split(" ")), r2 = (null === (n2 = e2.scope) || void 0 === n2 ? void 0 : n2.split(" ")) || [], s2 = o2.scope && r2.reduce((e3, t4) => e3 && i2.has(t4), true);
...
var Q = (e2) => "number" == typeof e2;
var ee = ["iss", "aud", "exp", "nbf", "iat", "jti", "azp", "nonce", "auth_time", "at_hash", "c_hash", "acr", "amr", "sub_jwk", "cnf", "sip_from_tag", "sip_date", "sip_callid", "sip_cseq_num", "sip_via_branch", "orig", "dest", "mky", "events", "toe", "txn", "rph", "sid", "vot", "vtm"];
var te = (e2) => {
  ...
  const t2 = ((e3) => {
    ...
    const r2 = JSON.parse(_(o3)), s2 = { __raw: e3 }, a2 = {};
    return Object.keys(r2).forEach((e4) => {
      s2[e4] = r2[e4], ee.includes(e4) || (a2[e4] = r2[e4]);
    }), { encoded: { header: n3, payload: o3, signature: i3 }, header: JSON.parse(_(n3)), claims: s2, user: a2 };
  })(e2.id_token);
...
var se = { get(e2) {
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true, sameSite: "none" }), (null == n2 ? void 0 : n2.daysUntilExpire) && (o2.expires = n2.daysUntilExpire), (null == n2 ? void 0 : n2.cookieDomain) && (o2.domain = n2.cookieDomain), ie(e2, JSON.stringify(t2), o2);
}, remove(e2, t2) {
  let n2 = {};
...
var ae = { get(e2) {
  ...
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true }), (null == n2 ? void 0 : n2.daysUntilExpire) && (o2.expires = n2.daysUntilExpire), (null == n2 ? void 0 : n2.cookieDomain) && (o2.domain = n2.cookieDomain), ie(`_legacy_${e2}`, JSON.stringify(t2), o2), se.save(e2, t2, n2);
}, remove(e2, t2) {
  let n2 = {};
...
var we = { memory: () => new $().enclosedCache, localstorage: () => new Y() };
var ye = (e2) => we[e2];
var be = (t2) => {
...
var Ie = class {
  ...
  async internalFetchWithAuth(e2, t2, n2) {
    const o2 = this.buildBaseRequest(e2, t2);
    await this.prepareRequest(o2);
    const i2 = await this.config.fetch(o2);
...
var Te = class {
  ...
  async _verifyIdToken(e2, t2, n2) {
    ...
    return te({ iss: this.tokenIssuer, aud: this.options.clientId, id_token: e2, nonce: t2, organization: n2, leeway: this.options.leeway, max_age: (i2 = this.options.authorizationParams.max_age, "string" != typeof i2 ? i2 : parseInt(i2, 10) || void 0), now: o2 });
    var i2;
  }
  _processOrgHint(e2) {
  ...
  async loginWithPopup(e2, t2) {
    ...
    const i2 = await ((e3) => new Promise((t3, n3) => {
      ...
      const i3 = setInterval(() => {
        e3.popup && e3.popup.closed && (clearInterval(i3), clearTimeout(r3), window.removeEventListener("message", o3, false), n3(new p(e3.popup)));
      }, 1e3), r3 = setTimeout(() => {
        clearInterval(i3), n3(new l(e3.popup)), window.removeEventListener("message", o3, false);
  ...
  async loginWithRedirect(t2 = {}) {
    var n2;
    const o2 = be(t2), { openUrl: i2, fragment: r2, appState: s2 } = o2, a2 = e(o2, ["openUrl", "fragment", "appState"]), c2 = (null === (n2 = a2.authorizationParams) || void 0 === n2 ? void 0 : n2.organization) || this.options.authorizationParams.organization, u2 = await this._prepareAuthorizeUrl(a2.authorizationParams || {}), { url: h2 } = u2, d2 = e(u2, ["url"]);
  ...
  async handleRedirectCallback(e2 = window.location.href) {
    ...
    const { state: n2, code: o2, error: i2, error_description: r2 } = ((e3) => {
    ...
    return await this._requestToken(Object.assign({ audience: s2.audience, scope: s2.scope, code_verifier: s2.code_verifier, grant_type: "authorization_code", code: o2 }, d2 ? { redirect_uri: d2 } : {}), { nonceIn: c2, organization: a2 }), { appState: s2.appState };
  }
  ...
  async getTokenSilently(e2 = {}) {
    var t2;
    const n2 = Object.assign(Object.assign({ cacheMode: "on" }, e2), { authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), { scope: G(this.scope, null === (t2 = e2.authorizationParams) || void 0 === t2 ? void 0 : t2.scope) }) }), o2 = await ((e3, t3) => {
      let n3 = fe[t3];
  ...
  async getTokenWithPopup(e2 = {}, t2 = {}) {
    var n2;
    const o2 = Object.assign(Object.assign({}, e2), { authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), { scope: G(this.scope, null === (n2 = e2.authorizationParams) || void 0 === n2 ? void 0 : n2.scope) }) });
    t2 = Object.assign(Object.assign({}, s), t2), await this.loginWithPopup(o2, t2);
    return (await this.cacheManager.get(new M({ scope: o2.authorizationParams.scope, audience: o2.authorizationParams.audience || "default", clientId: this.options.clientId }))).access_token;
  }
  ...
  async logout(t2 = {}) {
    var n2;
    const o2 = be(t2), { openUrl: i2 } = o2, r2 = e(o2, ["openUrl"]);
  ...
  async _getTokenFromIFrame(e2) {
    ...
    const { url: o2, state: i2, nonce: r2, code_verifier: s2, redirect_uri: a2, scope: c2, audience: h2 } = await this._prepareAuthorizeUrl(t2, { response_mode: "web_message" }, window.location.origin);
    try {
  ...
  async _getTokenUsingRefreshToken(e2) {
    ...
    const n2 = e2.authorizationParams.redirect_uri || this.options.authorizationParams.redirect_uri || window.location.origin, o2 = "number" == typeof e2.timeoutInSeconds ? 1e3 * e2.timeoutInSeconds : null;
    try {
      const i2 = await this._requestToken(Object.assign(Object.assign(Object.assign({}, e2.authorizationParams), { grant_type: "refresh_token", refresh_token: t2 && t2.refresh_token, redirect_uri: n2 }), o2 && { timeout: o2 }));
  ...
  async _getEntryFromCache({ scope: e2, audience: t2, clientId: n2 }) {
    const o2 = await this.cacheManager.get(new M({ scope: e2, audience: t2, clientId: n2 }), 60);
    if (o2 && o2.access_token) {
      const { token_type: e3, access_token: t3, oauthTokenScope: n3, expires_in: i2 } = o2, r2 = await this._getIdTokenFromCache();
  ...
  async _requestToken(e2, t2) {
    const { nonceIn: n2, organization: o2 } = t2 || {}, i2 = await J(Object.assign({ baseUrl: this.domainUrl, client_id: this.options.clientId, auth0Client: this.options.auth0Client, useFormData: this.options.useFormData, timeout: this.httpTimeoutMs, dpop: this.dpop }, e2), this.worker), r2 = await this._verifyIdToken(i2.id_token, n2, o2);
    return await this._saveEntryInCache(Object.assign(Object.assign(Object.assign(Object.assign({}, i2), { decodedToken: r2, scope: e2.scope, audience: e2.audience || "default" }), i2.scope ? { oauthTokenScope: i2.scope } : null), { client_id: this.options.clientId })), this.cookieStorage.save(this.isAuthenticatedCookieName, true, { daysUntilExpire: this.sessionCheckExpiryDays, cookieDomain: this.options.cookieDomain }), this._processOrgHint(o2 || r2.claims.org_id), Object.assign(Object.assign({}, i2), { decodedToken: r2 });
  }
...
var Auth0Provider = function(opts) {
  ...
  var contextValue = (0, import_react.useMemo)(function() {
    return __assign(__assign({}, state), { getAccessTokenSilently, getAccessTokenWithPopup, getIdTokenClaims, loginWithRedirect, loginWithPopup, logout, handleRedirectCallback, getDpopNonce, setDpopNonce, generateDpopProof, createFetcher });
  }, [
    state,
